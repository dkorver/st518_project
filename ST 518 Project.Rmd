...
The Summary Stats for Time by Group Table shows a decrease in dissolving time as temperature increases regardless of `Brand` or `Stirred` status. Name Brand generally had a higher dissolving time, but occasionally, Store Brand would have a higher dissolve time than Name Brand. The same was true for when the water was not stirred, both instances at the 6 degree temperature. There was also some unusually high standard deviations for Name Brand at the 23 and 40 degrees with their standard deviations at 2.64 and 1.6, respectively. Both instances where the water was stirred. Store Brand at 6 degrees, not stirred had a standard deviation of 1.3. The standard deviations tended to range between 0.2 and 0.77.         
