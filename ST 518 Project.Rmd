...
Our model is $Y_{ijk}=\mu+\alpha_i+B_j+\gamma_k+\epsilon_l{ijk}$  
...
Our model is $Y_{ijkl}=\mu+\alpha_i+B_j+\gamma_k+(\alpha B)_{ij}+(\alpha\gamma)_{ik}+(B\gamma)_{jk}+(\alpha B\gamma)_{ijk}+\epsilon_l{ijk}$  
