...
### Coefficients for Two Factor Crossed Mixed Effects Model  
...
### Coefficients of Three Factor Crossed Mixed Effects Model  

```{r model 3 coefficients}
coefficients(amod3)
```
...
model_names <- c("Two Factor Crossed Mixed Effects", "Model 2", "Three Factor Crossed Mixed Effects")
...
```{r, echo = FALSE, eval = FALSE, fig.align='center', out.width = "300px"}
