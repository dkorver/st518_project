...
Our model is $Y_{ijk}=\mu+\alpha_i+B_j+(\alpha B)_{ij}+E_{ijk}$  

for $i=1,2$;  $j=1,2,3$;  $k=1,...,8$  

where $B_j$*~iid* $N(0,\sigma_\beta^2)$;  $(\alpha B)_{ij}$*~iid* $N(0,\sigma_{\alpha B}^2)$;  $E_{ijk}$*~iid* $N(0,\sigma^2)$  
...
```{r interaction, fig.align='center', out.width = "240px"}
